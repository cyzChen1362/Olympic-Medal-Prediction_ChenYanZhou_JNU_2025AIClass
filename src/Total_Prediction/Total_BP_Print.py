...
# 1. 读取数据
file_path = r'..\Total_Prediction\Total_BP_Prediction_Data_with_Pred.xlsx'
...
plt.grid(True)
plt.tight_layout()
plt.savefig(r'..\Total_Prediction\Total_BP_Residual_Plot.png', dpi=300)
plt.show()
...
plt.tight_layout()
plt.savefig(r'..\Total_Prediction\Total_BP_Confint_Plot.png', dpi=300)
plt.show()
