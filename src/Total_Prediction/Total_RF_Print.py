...
# 1. 读取数据
file_path = r'C:\Users\cyz13\PycharmProjects\AI_ClassProject\src\Total_Prediction\Total_RF_Prediction_Data_with_Pred.xlsx'
...
plt.grid(True)
plt.tight_layout()
plt.savefig(r'C:\Users\cyz13\PycharmProjects\AI_ClassProject\src\Total_Prediction\Total_RF_Residual_Plot.png', dpi=300)
plt.show()
...
plt.tight_layout()
plt.savefig(r'C:\Users\cyz13\PycharmProjects\AI_ClassProject\src\Total_Prediction\Total_RF_Confint_Plot.png', dpi=300)
plt.show()
